...
| 角色 | 音色 | Voice ID |
|------|------|----------|
| 阿福 | 冷漠男声 | `ICL_uranus_zh_male_lengmonanyou_tob` |
| 老徐头 | 诡异神秘男声 | `ICL_uranus_zh_male_guiyishenmi_tob` |
| 年轻女角色 | 纯真少女 | `ICL_uranus_zh_female_chunzhenshaonv_tob` |
| 旁白 | 灿灿 | `zh_female_cancan_uranus_bigtts` |

### 自动分配规则

其他角色根据描述关键词自动匹配音色：
- **男性**：根据年龄（青年/中年/老年）+ 性格特征（冷漠/粗犷/阳光等）
- **女性**：根据性格特征（温柔/知性/妩媚/成熟等）
